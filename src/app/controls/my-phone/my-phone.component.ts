...
@Component({
  ...
  styleUrl: './my-phone.component.scss',
...
export class MyPhoneComponent implements ControlValueAccessor, MatFormFieldControl<MyTel>, OnDestroy {
  static nextId = 0;
  ...
  readonly id = `example-tel-input-${MyPhoneComponent.nextId++}`;
